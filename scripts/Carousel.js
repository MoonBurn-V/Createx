...
// На случай если прокрутка появится
// class Carousel {
//     selectors = {
//         cardContainer: '[data-js-card-container]',
//         card: '[data-js-card]',
...
//             this.cardContainerElement.addEventListener('touchmove', (event) => {
//                 this.currentTime = new Data().getTime();

//                 if(this.currentTime - this.touchEndTime > 200) {
//                     return;
//                 }
...
//                 this.horizontalThreshold = 20;

//                 if(Math.abs(this.deltaY) > Math.abs(this.deltaX) + this.horizontalThreshold) {
//                     event.preventDefault();
//                 }
//             })
